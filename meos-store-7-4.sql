...
CREATE TABLE `addresses`  (
  ...
  INDEX `id_user_address`(`id_user`) USING BTREE,
  CONSTRAINT `id_user_address` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 68 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of addresses
-- ----------------------------
INSERT INTO `addresses` VALUES (1, '124 đường Mạc Thiên Tích, phường Xuân Khánh, quận Ninh Kiều, TP.Cần Thơ', 2);
INSERT INTO `addresses` VALUES (2, '12 đường Lý Tự Trọng, phường An Lạc, quận Ninh Kiều, TP.Cần Thơ', 3);
INSERT INTO `addresses` VALUES (3, '45 đường Trần Hưng Đạo, phường Xuân Khánh, quận Ninh Kiều, TP.Cần Thơ', 4);
INSERT INTO `addresses` VALUES (4, '82 đường Trần Văn Hoài, phường Xuân Khánh, quận Ninh Kiều, TP.Cần Thơ', 5);
INSERT INTO `addresses` VALUES (5, '97 đường Hùng Vương, phường An Cư, quận Ninh Kiều, TP.Cần Thơ', 6);
INSERT INTO `addresses` VALUES (6, '48 đường Trần Ngọc Quế, phường Xuân Khánh, quận Ninh Kiều, TP.Cần Thơ', 7);
INSERT INTO `addresses` VALUES (7, '178 đường Nguyễn Việt Hồng, phường Xuân Khánh, quận Ninh Kiều, TP.Cần Thơ', 8);
INSERT INTO `addresses` VALUES (8, '132 đường Mậu Thân, phường Xuân Khánh, quận Ninh Kiều, TP.Cần Thơ', 9);
INSERT INTO `addresses` VALUES (9, '228 đường Nguyễn Trãi, phường Cái Khế, quận Ninh Kiều, TP.Cần Thơ', 10);
INSERT INTO `addresses` VALUES (10, '312 đường Nguyễn Văn Linh, phường Hưng Lợi, quận Ninh Kiều, TP.Cần Thơ', 11);
INSERT INTO `addresses` VALUES (12, '93A đường Phan Chu Trinh, TP Cần Thơ', 2);
INSERT INTO `addresses` VALUES (14, '132 đường Mậu Thân, phường Xuân Khánh, quận Ninh Kiều, TP.Cần Thơ', 1);
INSERT INTO `addresses` VALUES (15, 'dfdf82 đường Trần Văn Hoài, phường Xuân Khánh, quận Ninh Kiều, TP.Cần Thơ', 16);
INSERT INTO `addresses` VALUES (16, '95/5 đường Phạm Ngũ Lão, phường An Cư, TP Cần Thơ', 17);
INSERT INTO `addresses` VALUES (66, '312 đường Nguyễn Văn Linh, phường Hưng Lợi, quận Ninh Kiều, TP.Cần Thơ', 15);
INSERT INTO `addresses` VALUES (67, '12B đường Nguyễn Văn Linh, TP Cần Thơ', 15);
...
INSERT INTO `cart` VALUES (15, 3, 1);
INSERT INTO `cart` VALUES (15, 10, 1);
INSERT INTO `cart` VALUES (15, 115, 1);
...
CREATE TABLE `comments`  (
  ...
  CONSTRAINT `fk_id_product_comment` FOREIGN KEY (`id_product`) REFERENCES `products` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Records of comments
-- ----------------------------
INSERT INTO `comments` VALUES (2, 6, 15, 'ngon lắm á nha', 5, '10/03/2022');
INSERT INTO `comments` VALUES (3, 1, 4, 'Hàng tốt lắm nha', 3, '10/03/2022');
INSERT INTO `comments` VALUES (14, 1, 15, 'Cún nhà mình thích lắm', 4, '02/03/2022');
INSERT INTO `comments` VALUES (15, 1, 15, 'tệ', 5, '02/03/2022');
INSERT INTO `comments` VALUES (26, 32, 15, 'đẹp lắm nha', 5, '11/03/2022');
INSERT INTO `comments` VALUES (28, 46, 15, 'Thức ăn rất nhiều', 5, '02/04/2022');
INSERT INTO `comments` VALUES (29, 82, 15, 'Đẹp, rất dễ thương luôn ', 5, '07/04/2022');
...
-- ----------------------------
INSERT INTO `discounts` VALUES (0, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
INSERT INTO `discounts` VALUES (1, 'tháng 8', 10, '2022-04-07 12:38:21', '2022-04-10 12:38:30');
...
-- ----------------------------
INSERT INTO `order_details` VALUES (1, 1, 4, 252000);
...
INSERT INTO `order_details` VALUES (15, 1, 5, 252000);
INSERT INTO `order_details` VALUES (15, 4, 3, 95000);
INSERT INTO `order_details` VALUES (32, 2, 2, 131000);
INSERT INTO `order_details` VALUES (32, 40, 1, 80000);
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1, '2021-05-20', '2021-05-08', 3, 'DCB', NULL, NULL);
...
INSERT INTO `orders` VALUES (15, '2021-05-28', '2021-12-17', 9, 'DCB', NULL, NULL);
INSERT INTO `orders` VALUES (32, '2021-12-14', NULL, 10, 'CXL', '228 đường Nguyễn Trãi, phường Cái Khế, quận Ninh Kiều, TP.Cần Thơ', '0331489511');
...
CREATE TABLE `products`  (
  ...
  `benerfits` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `id_products_type` int(10) NOT NULL,
  `quantity` int(20) NULL DEFAULT NULL,
  `price_discount` decimal(10, 0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `products` VALUES (64, 'Sữa Tắm Chống Ngứa Do Bọ Ve Cắn Tropiclean 355ml', 395000, 'Sản phẩm sử dụng các chất được gọi là Alpha Hydrosys có chức năng làm dịu các vết tổn thương do bọ ve cắn trên da thú cưng. Alpha Hydrosys không những giúp làm dịu vết cắn mà còn giúp tăng sinh collagen và các tế bào trên da nhằm giúp vết thương của thú c', 'Hiểu được điều này, các sản phẩm trị ve bọ chét cho thú cưng trở nên rất phổ biến. Tuy nhiên, sản phẩm giúp cải thiện tình trạng da của thú cưng khi bị ve bọ chét cắn thì lại hiếm hơn. Đây là lúc sữa tắm giúp giảm ngứa và khó chịu do ve và bọ chét cắn phá', '69.png', 12, 300, NULL);
INSERT INTO `products` VALUES (65, 'Sữa Tắm Cho Mèo Enoug SOS 530ml – Bảo Vệ Da – Đài Loan', 130000, 'Thành phần chứa hầu hết các nguyên liệu thiên nhiên được sản xuất từ tinh hoa thực vật. Độ PH có trong sản phẩm chiếm 7-7,14, hỗ trợ cân bằng độ PH nhằm giữ âm và đem lại cho mèo 1 bộ lông bóng mượt. Các sinh vật kháng khuẩn có trong sản phẩm giúp tiêu di', 'Tinh dầu tự nhiên từ thực vật mang đến hương thơm dịu giúp khử mùi, lưu hương đến hơn 1 tuần, đảm bảo an toàn cho thú cưng và chủ nuôi. Loại bỏ da chết và bụi bẩn trên lông mèo.', '49.png', 12, 250, NULL);
INSERT INTO `products` VALUES (66, 'Vòng Cổ Mèo Ferplast Ergoflex (22cm)', 219000, 'Vòng cổ cho mèo được nhập khẩu từ Ý. Được làm từ cao su tự nhiên', 'Chống thấm nước, thoáng mát. Hạn chế bám mùi sau khi sử dụng', '50.png', 13, 250, NULL);
INSERT INTO `products` VALUES (67, 'Kính Mát Bảo Vệ Mắt Cho Chó Mèo 8×6.5cm', 45000, 'Được làm từ các vật liệu hoàn toàn an toàn với lông và da của thú cưng. Thân kính có kích thước là 8cm, chiều dài gọng là 6.5cm, đường kính của tròng là 3cm. Phù hợp với tất cả các giống mèo và chó có kích cỡ nhỏ.', 'Sản phẩm được dùng để đeo cho chó mèo khi bạn muốn đưa chúng ra ngoài chơi. Được thiết kế rất thời trang, và sẽ khiến cho chó mèo trông sang chảnh hơn.', '51.png', 13, 300, NULL);
INSERT INTO `products` VALUES (68, 'Vòng cổ mèo Diamond 30cm', 30000, 'Họa tiết  ngộ nghĩnh và đáng yêu. Nhiều màu cho bạn lựa chọn. Chất liệu chắc chắn và thiết kế dày dặn cho độ bền cao, đồng thời tạo cảm giác êm ái khi đeo. Có kèm lục lạc leng keng để bạn dễ dàng biết được chú thú cưng đang ở đâu. Thiết kế khóa bấm giúp b', 'Có tác dụng giúp bạn giữ chặt và theo sát chú thú cưng của bạn. Thiết kế ngộ nghĩnh và đáng yêu của chiếc vòng cổ Diamond. Vòng cổ cho mèo còn là điểm nhấn nổi bật để chú thú cưng của bạn trông thật “sành điệu” trong mọi chuyến đi dạo hoặc chạy bộ đầy hứn', '70.png', 13, 250, NULL);
INSERT INTO `products` VALUES (69, 'Chuông hình đeo cổ cho thú cưng 26mm', 20000, 'Hãy cùng chuông màu đẹp mắt để bảo vệ và trang trí cho cún yêu thêm kute nhé. Có đủ màu và size cho bạn lựa chọn', 'Luôn là sự lựa chọn hàng đầu của bạn cho thú cưng của mình để cún nhà bạn đáng yêu hơn nữa với chuông màu, ngoài ra nó còn giúp bạn bảo vệ cún đấy. Nó sẽ phát ra âm thanh keng keng giúp bạn biết cún yêu nhà mình đang ở chỗ nào.', '71.png', 13, 300, NULL);
INSERT INTO `products` VALUES (70, 'Chụp bảo vệ khi dùng thuốc', 97000, 'Được làm từ chất liệu cao cấp, an toàn không gây hại.', 'Đây là dụng cụ an toàn  cho bạn khi cho cún cưng tiêm thuốc. Bạn có thể yên tâm rằng khi tiêm thuốc sẽ không còn bị chó cưng quay lại cắn vào tay nữa.', '72.png', 13, 300, NULL);
INSERT INTO `products` VALUES (71, 'Dây dắt yên ngựa tròn kèm nơ 0.6x130cm', 98000, 'Bền chắc, giá hợp lý: Chất liệu vải dù giúp dây dắt chó có yếm và tay cầm trợ lực có sự chắc chắn, tạo độ bền rất cao so với các sản phẩm dây dắt chó làm bằng chất liệu khác. Bên cạnh đó thiết kế dày dặn cũng tăng thêm độ bền của dây dắt chó và tạo cảm gi', 'Hình thức đẹp mắt, màu sắc tươi sáng của dây dắt chó còn rất phù hợp, giúp tô điểm thêm vẻ đẹp của các chú chó kể cả với các màu lông khác nhau.', '73.png', 13, 150, NULL);
INSERT INTO `products` VALUES (72, 'Gel Cho Mèo Gimcat Anti Hairball 50g – Trị Búi Lông – Đức', 165000, 'Sản phẩm bổ sung cellulose và beta-glucan giúp tăng khả năng đẩy phần lông thừa trong bao tử của mèo. Ngoài ra, beta-glucan còn là một chất giúp chống kích ứng đường tiêu hóa, rất tốt trong việc cải thiện khả năng tiêu hóa của mèo.', 'Bạn có thể cho mèo ăn 6cm gel mỗi ngày. 1cm tương đương 0.5g. Bạn có thể cho mèo liếm trực tiếp trên tay, trộn với thức ăn hoặc pha loãng với nước nếu mèo kén ăn.', '52.png', 14, 300, NULL);
INSERT INTO `products` VALUES (73, 'Gel Dinh Dưỡng Gimcat Derma 50g – Trị Viêm Da', 190000, 'Sản phẩm có công thức riêng biệt chứ Omega 3 và 6 giúp cải thiện tình trạng khô da ở mèo. Ngoài ra, gel còn có axit linoleic giúp tăng cường miễn dịch cho da và lông. Các chất dinh dưỡng trong gel được chiết xuất từ tảo chlorella giúp cung cấp vitamin và ', 'Sản phẩm được đặc chế để chuyên hỗ trợ điều trị và phòng ngừa các bệnh liên quan đến viêm da ở mèo. Phù hợp cho mèo trưởng thành trên 12 tháng tuổi. Sản phẩm giúp cho da mèo duy trì được độ cân bằng pH và tăng cường miễn dịch cho da một cách tự nhiên.', '74.png', 14, 150, NULL);
INSERT INTO `products` VALUES (74, 'Snack Ăn Sạch Răng Cho Mèo Feline Greenies 595g', 800000, 'Chicken Meal, Ground Wheat, Brewers Rice, Corn Gluten Meal, Poultry Fat (Preserved with Mixed Tocopherols), Oat Fiber, Natural Poultry Flavor, Ground Flaxseed, Brewers Dried Yeast, Potassium Chloride, Calcium Carbonate, Salt, Choline Chloride, Citric Acid', 'Sản phẩm này có chức năng hỗ trợ điều trị cho mèo. Cụ thể là giúp làm sạch răng mèo, lấy đi các cao răng và bám bẩn. Từ đó nâng cao chất lượng răng miệng và đảm bảo mèo có thể ăn uống khỏe mạnh hơn. Snack Greenies còn được nghiên cứu với công thức đặc biệ', '75.png', 14, 150, NULL);
INSERT INTO `products` VALUES (75, 'Gel Vệ Sinh Răng Chó Mèo Beaphar Tooth Gel (100g)', 181000, 'Gel vệ sinh răng sở hữu các loại Enzyme đặc biệt tốt trong việc đánh bật các vết bẩn, mảng bám trên răng của chó mèo.', 'Có thể sử dụng hằng ngày, dùng kèm hoặc dùng riêng với các sản phẩm răng miệng khác đều tốt. Hoàn toàn an toàn với chó mèo, phù hợp với mọi lứa tuổi.', '76.png', 14, 150, NULL);
INSERT INTO `products` VALUES (76, 'Xịt Trị Viêm Da, Ghẻ Có Mủ Alkin Fabricil 50ml ', 155000, 'Fabricil là một trong những sản phẩm trị viêm da, ghẻ da có mủ khá nổi tiếng và phổ biến vì tính hiệu quả và đặc trị. Sản phẩm có khả năng thẩm thấu cao để tăng tính hiệu quả trong thời gian ngắn.', 'Ngoài khả năng kháng khuẩn, giúp cho da của thú cưng mau lành bệnh, thì sản phẩm cũng giúp giảm ngứa và giảm cảm giác châm chích trên cơ thể thú cưng. Sản phẩm phù hợp và an toàn với chó mèo từ 8 tuần tuổi trở lên.', '77.png', 14, 230, NULL);
INSERT INTO `products` VALUES (77, 'Xịt Trị Ve, Rận, Ký Sinh Trùng Alkin Mitecyn 50ml', 155000, 'Alkin Mitecyn là một trong những sản phẩm nổi tiếng về đặc trị ve, rận và ký sinh trùng ở thú cưng.', 'Sản phẩm có khả năng thẩm thấu cao vì vậy giúp thuốc xịt hiệu quả hơn trong thời gian ngắn nhất. Sản phẩm phù hợp với cả chó và mèo trên 12 tuần tuổi.', '78.png', 14, 230, NULL);
INSERT INTO `products` VALUES (78, 'Bọt Nước Làm Sạch Chân Chó Mèo Cature Purelab 150ml', 170000, 'Bọt làm sạch chân Cature Purelab giúp lấy sạch các vết bẩn bám vào các vùng đệm trên chân của chó mèo. Sản phẩm còn có chức năng giữ ẩm giúp cho các đệm chân của thú cưng luôn mềm.', 'Bọt làm sạch chân còn được đi kèm với bàn chải được làm từ sợi silicon giúp lấy sạch các vết bẩn bám trên chân của chó mèo. Ngoài ra bọt còn có chức năng giảm ngứa, giúp cho thú cưng luôn cảm thấy thoải mái mỗi khi bạn làm vệ sinh chân của chúng. Bàn chải', '79.png', 14, 150, NULL);
INSERT INTO `products` VALUES (79, 'Bộ Trồng Cỏ Mèo Tươi Bioline 12g – Bổ Sung Chất Xơ, Giảm Stress', 55000, 'Cỏ mèo (cỏ bạc hà) là một loại thực vật rất tốt cho sức khoẻ của mèo, vì cỏ bạc hà giúp mèo giảm căng thẳng và thư giãn cơ thể. Thông thường, bạn có thể dùng cỏ mèo khô. Tuy nhiên, cỏ mèo tươi tự trồng sẽ giúp bổ sung chất xơ vì một số chú mèo có thói que', 'Việc chăm sóc cỏ mèo cũng đơn giản, không tốn của ban quá nhiều thời gian và cũng giúp cho bạn thư giãn hơn với việc tưới tiêu sau một ngày làm việc mệt nhọc. Mèo có thể dùng được bộ sản phẩm cỏ mèo từ 2 tuần đến 1 tháng, nếu cỏ mèo được tưới tiêu và chăm', '80.png', 15, 120, NULL);
INSERT INTO `products` VALUES (80, 'Cỏ Mèo Khô Dạng Ống Bioline 5g – Giúp Mèo Giảm Stress', 35000, 'Cỏ mèo là một loài thực vật có trong tự nhiên, có ảnh hưởng tới hệ thần kinh của mèo.', 'Cỏ mèo không những giúp cho chúng cảm thấy thư giãn hơn mà còn giúp giãn cơ thể. Từ đó, mèo sẽ có nhiều thời gian cho cơ thể nghỉ ngơi hơn. Sản phẩm được làm từ cỏ mèo khô nguyên chất, có hiệu quả cao và không gây hại cho thú cưng. Cỏ mèo là một trong nhữ', '81.png', 15, 230, NULL);
INSERT INTO `products` VALUES (81, 'Đường Hầm Sáng Tạo 12 Đoạn Hagen Catit Circuit', 606000, '100% được sản xuất tại Canada.  An toàn, không gây hại tới sức khỏe của mèo.', 'Dễ dàng gắn nối với 100 kiểu khác nhau. 12 đoạn và 1 quả bóng chạy bên trong. Kích thích sự tò mò của mèo. Hạn chế tình trạng lười biếng, giảm stress cho mèo', '82.png', 15, 150, NULL);
INSERT INTO `products` VALUES (82, 'Đồ Chơi Mèo Quào Hình Trái Tim Mon Ami Toy Cat', 88000, 'Sản xuất tại Việt Nam, Chất liệu tốt, có độ bền cao', 'Kích thích sự tò mò của mèo', '83.png', 15, 150, NULL);
INSERT INTO `products` VALUES (83, 'Cần Câu Cá Đồ Chơi Mon Ami Toy Cat', 25000, 'Sản xuất tại Việt Nam, Chất liệu tốt, có độ bền cao', 'Kích thích sự tò mò của mèo', '84.png', 15, 230, NULL);
INSERT INTO `products` VALUES (84, 'Đồ Chơi Bùng Binh Pawise Play', 148000, 'Sản xuất tại Việt Nam, Chất liệu tốt, có độ bền cao', 'Kích thích sự tò mò của mèo. Có banh để mèo khều, giúp hạn chế lười nhát ở mèo.', '85.png', 15, 120, NULL);
INSERT INTO `products` VALUES (85, 'Đồ Chơi Nhồi Bông Hình Rắn AFP Modern Cat Feather', 73000, 'Nhập khẩu từ Pháp, Có tiếng kêu khơi dậy trí tò mò của mèo, Có thể chuyển động được', 'Kích thích sự tò mò của mèo', '86.png', 15, 150, NULL);
INSERT INTO `products` VALUES (86, 'Đường Hầm Đồ Chơi AFP Lamb Find Me', 325000, 'Thiết kế từ Pháp, Có catnip bên trong giúp thu hút sự tò mò của mèo', 'Hỗ trợ giải tỏa tâm lý cho mèo được nuôi một mình, Giúp mèo thư giãn', '87.png', 15, 230, NULL);
INSERT INTO `products` VALUES (87, 'Đồ Chơi Nhồi Bông Hình Chuột AFP Green Rush', 99000, 'Sản xuất tại Việt Nam, Chất liệu tốt, có độ bền cao', 'Có nhồi catnip bên trong, giúp mèo thư giãn thoải mái', '88.png', 15, 150, NULL);
INSERT INTO `products` VALUES (88, 'Cần Câu AFP Dreams Catcher Ranga', 146000, 'Thiết kế từ Pháp, Sử dụng lông vũ tự nhiên, không gây hại cho mèo khi chơi', 'Giải tỏa cơn ngứa móng ở mèo.  Giúp mèo không cào đồ đạc trong nhà', '89.png', 15, 230, NULL);
INSERT INTO `products` VALUES (89, 'Ổ Nệm Giá Rẻ Cho Chó Mèo Hình Tròn', 150000, 'Sản phẩm được thiết kế gọn, nhẹ, tiện lợi phù hợp để đặt ở bất kỳ đâu, chất liệu vải mềm, mịn, đảm bảo an toàn không gây kích ứng cho vật nuôi. Sản xuất theo tiêu chuẩn thích hợp với thời tiết tại các nước Đông Nam Á mang lại sự ấm áp cho thú cưng vào nhữ', 'Mang lại cảm giác thư giãn, êm ái, và dễ dàng đi sâu vào giấc ngủ. Hỗ trợ nâng đỡ xương, cải thiện sức khỏe, đem đến không gian riêng an toàn, thoải mái và 1 giấc ngủ trọn vẹn cho thú cưng. Bạn có thể dễ dàng giặt sạch sản phẩm bằng máy giặt cho những lần', '90.png', 16, 150, NULL);
INSERT INTO `products` VALUES (90, 'Giường Thư Giãn Cho Mèo Hagen Catit', 573000, 'Được sản xuất tại Canada, hàng công ty xuất khẩu về Việt Nam. Bao gồm những cơ chế massage đầu, cổ, mặt, Bàn chải được thiết kế để có thể lấy đi lông chết hoặc bệnh, Vật liệu nhựa cao cấp, không chưa BPA, không ảnh hưởng đến sức khỏe mèo', 'Giường thông minh, vừa giúp mèo nằm thoải mái, vừa giúp chúng thư giãn', '91.png', 16, 230, NULL);
INSERT INTO `products` VALUES (91, 'Sofa Mèo Mon Ami Beddy (55cm)', 226000, 'Sản xuất tại Việt Nam, Sử dụng vật liệu thân thiện, không gây khó chịu cho mèo', 'Giúp mèo nghỉ ngơi, đảm bảo giấc ngủ', '92.png', 16, 150, NULL);
INSERT INTO `products` VALUES (92, 'Nhà gà con', 399000, 'Ngôi nhà được làm từ chất liệu cotton thông thoáng, dễ vệ sinh và phù hợp với khí hậu nóng ẩm ở Việt Nam. Bề mặt nằm có lớp lót cotton êm cùng thiết kế hình ngôi nhà với 3 mặt bao quanh nhằm tạo cho thú cưng của bạn cảm giác được che chở an toàn và ấm áp.', 'Nhà cho thú cưng sử dụng gam màu nổi bật kết hợp với những đường kẻ sọc cá tính, đây chắc chắn sẽ là nơi thư giãn lý tưởng, làm hài lòng những chú cún con xinh xắn.', '93.png', 16, 120, NULL);
INSERT INTO `products` VALUES (93, 'Cây mèo leo 3 tầng', 4930000, 'Các sản phẩm dành cho thú cưng với chất lượng tốt nhất, an toàn nhất với 95% sản phẩm đã được xuất khẩu sang thị trường Châu Âu và Châu Mỹ.', 'Cây mèo leo 3 tầng sẽ giúp bạn tiết kiệm không gian và cho mèo một khu sinh hoạt đầy đủ nhất. Mèo sẽ leo lên cao khi vui chơi và nghỉ ngơi ở dưới khi cần ngủ.', '94.png', 16, 230, NULL);
INSERT INTO `products` VALUES (94, 'Lồng sơm tĩnh điện cho mèo ', 320000, 'Chuồng mèo 3 tầng sơn tĩnh điện nan ống', '\"Với thiết kế nhiều tầng, nan ống to cực kỳ chắc chắn, dễ dàng di chuyển.', '95.jpg', 16, 200, NULL);
INSERT INTO `products` VALUES (95, 'Nệm khỉ con', 355000, 'Chất liệu cotton thông thoáng, dễ vệ sinh, rất phù hợp với khí hậu nóng ẩm ở Việt Nam. Bề mặt nằm có 2 lớp nệm tạo sự êm ái, thú cưng nhà bạn sẽ luôn có cảm giác được nâng niu và yêu chiều.', 'Thiết kế sinh động với gam màu nổi bật và hình ngộ nghĩnh họa tiết mang đến sự quen thuộc và gần gũi cho thú cưng đáng yêu trong nhà.', '96.png', 16, 120, NULL);
INSERT INTO `products` VALUES (96, 'Balo vận chuyển chó mèo Phi hành gia (da)', 479000, 'Chất liệu da mềm mại, thoáng khí. 2 cửa tích hợp (cầu tròn, lưới phẳng) dễ dàng thay đổi. ', 'Thiết kế phi hành gia độc đáo, dễ thương, Màu sắc nổi bật, bắt mắt', '97.png', 17, 230, NULL);
INSERT INTO `products` VALUES (98, 'Vali Vận Chuyển Gấp Lại Pawise Travel', 1360000, 'Thương hiệu nổi tiếng ở Châu Âu và Mỹ, Thiết kế thoáng mát, giúp thú cưng cảm thấy thoải mái khi di chuyển', 'Sử dụng để vận chuyển thú cưng đi xa như trên máy bay hay tàu hỏa. Dễ dàng gấp lại, gọn nhẹ và đơn giản', '99.png', 17, 120, NULL);
INSERT INTO `products` VALUES (99, 'Balo di chuyển phi hành gia (nhựa trong)', 399000, 'Điểm đặc biệt của balo là nhựa trong sang trọngSản phẩm được làm từ những chất liệu thân thiện, không độc hại và nhất là dễ dàng lau chùi khi bám bẩn', 'Với sản phẩm này, chó mèo cưng của bạn có thể nhìn ra thế giới và tận hưởng phong cảnh, nhìn ngắm bên ngòai, tương tác với thế giới bên ngoài', '100.png', 17, 200, NULL);
INSERT INTO `products` VALUES (100, 'Túi xách vận chuyển thú cưng bằng vải lớn', 15500, 'Túi xách vận chuyển cho chó mèo, kiểu dáng và màu sắc đẹp, hấp dẫn thú cưng nhà bạn, chất liệu bền, chắc chắn', 'Với sản phẩm này, chó mèo cưng của bạn có thể nhìn ra thế giới và tận hưởng phong cảnh, nhìn ngắm bên ngòai, tương tác với thế giới bên ngoài', '101.png', 17, 230, NULL);
INSERT INTO `products` VALUES (101, 'Lồng vận chuyển chó mèo', 910000, 'Chất liệu lồng bằng nhựa cao cấp thoáng mát và cửa khung thép chắc chắn, cầm chắc tay.', 'Với sản phẩm này, chó mèo cưng của bạn có thể nhìn ra thế giới và tận hưởng phong cảnh, nhìn ngắm bên ngòai, tương tác với thế giới bên ngoài', '102.png', 17, 120, NULL);
INSERT INTO `products` VALUES (102, 'Khay Vệ Sinh 49cm Mon Ami Hygiene', 198000, 'Vật liệu thiết kế gọn nhé, có độ bền cao. Thiết kế để mèo dễ dàng đi vệ sinh và lấp chất thải', 'Áp dụng công nghệ nước ngoài giúp hạn chế mùi hôi chất thải', '103.png', 18, 230, NULL);
INSERT INTO `products` VALUES (103, 'Chén Ăn Chậm Nhiều Lỗ Hagen Catit – Trị Mèo Lười Ăn', 345000, 'Được sản xuất và kiểm định tại Canada, nhập khẩu theo đường chính ngạch về Việt Nam, 100% chính hãng, đảm bảo về chất lượng sản phẩm.', 'Khuyến khích mèo tự lấy đồ ăn. Giảm thiểu bệnh lười biếng ở mèo. Kích thích sự phát triển về thể chất của mèo. Hạn chế không cho mèo ăn quá nhiều, dễ gây béo phì, thừa cân.', '104.png', 18, 120, NULL);
INSERT INTO `products` VALUES (104, 'Khay Trồng Cỏ Mèo Hagen Catit', 343000, 'Thương hiệu Canada,  Áp dụng kết cấu hiện đại, giúp cân bằng lượng nước để cỏ phát triển tốt', 'Sử dụng công nghệ cải tiến, giúp giữ đất tối ưu để trổng cỏ mèo, Có lưới đặc biệt giúp ngăn không cho mèo bới đất', '105.png', 18, 230, NULL);
INSERT INTO `products` VALUES (105, 'Chén Ăn Thông Minh Cho Mèo Hagen Catit – Kiểm Soát Thức Ăn', 575000, 'Thương hiệu Canada, được sản xuất và kiểm định khắc khe theo tiêu chuẩn Bắc Mỹ. Thiết kế có nhiều bậc giúp tăng độ khó khi lấy thức ăn. Chân đế cố định chắc chắn', 'Giúp cải thiện sự phát triển ở mèo. Miệng ống mở rộng giúp dễ đặt thức ăn .Kích thích bản năng kiếm thức ăn tự nhiên ở mèo', '106.png', 18, 200, NULL);
INSERT INTO `products` VALUES (106, 'Chén Melamine Đôi Mon Ami Bowl', 68000, 'Sản xuất tại Việt Nam, Vật liệu thân thiện với chó mèo', 'Thiết kế phù hợp với chiều cao của mọi giống chó mèo', '107.png', 18, 120, NULL);
INSERT INTO `products` VALUES (107, 'Tô Inox Mon Ami Bowl', 53000, 'Sản xuất tại Việt Nam, Vật liệu thân thiện với chó mèo', 'Thiết kế phù hợp với chiều cao của mọi giống chó mèo', '108.png', 18, 230, NULL);
INSERT INTO `products` VALUES (108, 'Chén Inox Màu Kem Hình Xương Pugmarks Feedy (1.8l)', 131000, 'Thương hiệu Ấn Độ, Inox cao cấp, dễ chà rữa và không bám mùi', 'Thiết kế phù hợp với chiều cao của mọi giống chó mèo', '109.png', 18, 300, NULL);
INSERT INTO `products` VALUES (109, 'Chén Nhựa Họa Tiết Cá Pawise Feeding', 41000, 'Thương hiệu nổi tiếng ở Châu Âu và Mỹ, Nhựa tổng hợp an toàn cho thú cưng', 'Thiết kế thấp, thú cưng không phải rướn khi ăn', '110.png', 18, 200, NULL);
INSERT INTO `products` VALUES (110, 'Chén Nhựa Ăn Chậm Ferplast Magnus', 271000, 'Đồ dùng cho chó mèo được nhập khẩu từ Ý', 'Hạn chế tình trạng ăn nhanh, gây béo phì và các bệnh tiêu hóa, Có đế chống trượt, giúp chén không di chuyển khi thú cưng ăn', '111.png', 18, 510, NULL);
...
INSERT INTO `products` VALUES (130, 'Cát Vệ Sinh Hương Quýt Vani Sanicat Bentonite (10l)', 205000, 'Xuất xứ thương hiệu Tây Ban Nha,  Không bụi, có hương thơm và sử dụng lâu dài, 100% chất liệu Bentonite trắng tự nhiên giúp cát có khả năng vón cục tốt', 'Kiểm soát vi khuẩn và khử mùi tốt, Không vương vãi, gây bụi bẩn trên nền nhà', '131.png', 21, 120, NULL);
INSERT INTO `products` VALUES (131, 'Cát Thuỷ Tinh Hương Lô Hội Sanicat Silica Gel (15l)', 411000, 'Xuất xứ thương hiệu Tây Ban Nha. Không bụi, có hương thơm và sử dụng lâu dài. Áp dụng công nghệ cái tiến mới giúp tăng độ kết dính của cát khi gặp chất thải,  Thời gian sử dụng từ 1 tháng trở lên cho 1 chú m', 'Cát thủy tinh không bám vào móng hoặc các kẽ chân, giúp mèo thoải mái. Không vương vãi, gây bụi bẩn trên nền nhà', '132.png', 21, 300, NULL);
INSERT INTO `products` VALUES (132, 'Cát Thuỷ Tinh Vón Cục Hương Hoa Sanicat Silica Gel (5l)', 183000, 'Xuất xứ thương hiệu Tây Ban Nha. Không bụi, có hương thơm và sử dụng lâu dài. Áp dụng công nghệ cái tiến mới giúp tăng độ kết dính của cát khi gặp chất thải,  Thời gian sử dụng từ 1 tháng trở lên cho 1 chú m', 'Cát thủy tinh không bám vào móng hoặc các kẽ chân, giúp mèo thoải mái. Không vương vãi, gây bụi bẩn trên nền nhà', '133.png', 21, 120, NULL);
...
-- ----------------------------
INSERT INTO `products_type` VALUES (1, 'Thức ăn cho chó', 1, 'pet-food.png');
INSERT INTO `products_type` VALUES (2, 'Sữa tắm ', 1, 'pet-shampoo.png');
INSERT INTO `products_type` VALUES (3, 'Phụ kiện cho chó', 1, 'dog-collar.png');
INSERT INTO `products_type` VALUES (4, 'Thực phẩm chức năng ', 1, 'vaccine.png');
INSERT INTO `products_type` VALUES (5, 'Đồ chơi cho chó', 1, 'pet-toy.png');
INSERT INTO `products_type` VALUES (6, 'Chuồng, nệm cho chó', 1, 'dog-house.png');
INSERT INTO `products_type` VALUES (7, 'Balo cho chó', 1, 'pet-supplies.png');
INSERT INTO `products_type` VALUES (8, 'Vật dụng ăn uống', 1, 'pet-feeder.png');
INSERT INTO `products_type` VALUES (9, 'Quần áo cho chó', 1, 'dress.png');
INSERT INTO `products_type` VALUES (10, 'Pate các loại cho chó', 1, 'canned-food.png');
INSERT INTO `products_type` VALUES (11, 'Thức ăn cho mèo', 2, 'pet-food.png');
INSERT INTO `products_type` VALUES (12, 'Sữa tắm', 2, 'pet-shampoo.png');
INSERT INTO `products_type` VALUES (13, 'Phụ kiện cho mèo', 2, 'dog-collar.png');
INSERT INTO `products_type` VALUES (14, 'Thực phẩm chức năng ', 2, 'vaccine.png');
INSERT INTO `products_type` VALUES (15, 'Đồ chơi cho mèo', 2, 'pet-toy.png');
INSERT INTO `products_type` VALUES (16, 'Chuồng cho mèo', 2, 'dog-house.png');
INSERT INTO `products_type` VALUES (17, 'Balo cho mèo', 2, 'pet-supplies.png');
INSERT INTO `products_type` VALUES (18, 'Vật dụng ăn uống ', 2, 'pet-feeder.png');
INSERT INTO `products_type` VALUES (19, 'Quần áo cho mèo', 2, 'dress.png');
INSERT INTO `products_type` VALUES (20, 'Pate cho mèo', 2, 'canned-food.png');
INSERT INTO `products_type` VALUES (21, 'Cát mèo', 2, '1648112285.png');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'Hầu Diễm Xuân', '0391278359', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'admin', 0, 'xuan.jpg');
INSERT INTO `users` VALUES (2, 'Nguyễn Tùng Lâm', '0338309523', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'lam@gmail.com', 1, 'xuan.jpg');
INSERT INTO `users` VALUES (3, 'Nguyễn Hoàng Thông', '0358309329', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'thong@gmail.com', 1, NULL);
INSERT INTO `users` VALUES (4, 'Hồng Thúy An', '0123763585', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'xuan@gmail.com', 1, NULL);
INSERT INTO `users` VALUES (5, 'Phạm Chí Trung', '0925385162', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'trung@gmail.com', 1, NULL);
INSERT INTO `users` VALUES (6, 'Đoàn Duy Thanh', '0873174284', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'thanh@gmail.com', 1, NULL);
INSERT INTO `users` VALUES (7, 'Nguyễn Huỳnh Hoàng Phúc', '0836109481', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'phuc@gmail.com', 1, NULL);
INSERT INTO `users` VALUES (8, 'Trần Văn Thiệt', '0927385387', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'thiet@gmail.com', 1, NULL);
INSERT INTO `users` VALUES (9, 'Nguyễn Thị Thúy Lựu', '0391278359', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'luu@gmail.com', 1, NULL);
INSERT INTO `users` VALUES (10, 'Trịnh Kim Chi', '0331489511', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'chi@gmail.com', 1, '');
INSERT INTO `users` VALUES (11, 'Trần Phương Thảo', '0702137273', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'thao@gmail.com', 1, NULL);
INSERT INTO `users` VALUES (15, 'Hầu Diễm Xuân', '0128563754', '$2y$10$cKS1ZrCkJVLLsC/.SbByuOyL7aFPEfjyQyu.Wp49r.X4BLnRdz6yi', 'diemxuan@gmail.com', 1, '1649214995.jpg');
INSERT INTO `users` VALUES (16, 'Nguyễn Văn Linh', '0123763585', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'linh@gmail.com', 0, NULL);
INSERT INTO `users` VALUES (17, 'Hồ Văn Nam', '0925385162', '$2y$10$tMMXcJbTjR70cbC5pW6hGu3QvNPNwOd2YXz09UHrd107aqPDe1uMm', 'nam@gmail.com', 0, NULL);

-- ----------------------------
-- Triggers structure for table order_details
-- ----------------------------
DROP TRIGGER IF EXISTS `trigger_inventory`;
delimiter ;;
CREATE TRIGGER `trigger_inventory` BEFORE INSERT ON `order_details` FOR EACH ROW BEGIN
	DECLARE quantity INT;
	SELECT quantity into quantity
	FROM PRODUCTS P WHERE P.id = NEW.id_product;
	IF new.amount > @quantity THEN 
			SET NEW.id_order = null;
	ELSE  
		UPDATE products SET quantity = quantity - NEW.amount WHERE id = NEW.id_product;
	END IF;
end
;;
delimiter ;
...
-- Triggers structure for table order_details
-- ----------------------------
DROP TRIGGER IF EXISTS `trigger_update_inventory`;
delimiter ;;
CREATE TRIGGER `trigger_update_inventory` AFTER UPDATE ON `order_details` FOR EACH ROW BEGIN
	UPDATE products
...
-- Triggers structure for table order_details
-- ----------------------------
DROP TRIGGER IF EXISTS `trigger_delete_inventory`;
delimiter ;;
CREATE TRIGGER `trigger_delete_inventory` AFTER DELETE ON `order_details` FOR EACH ROW BEGIN
